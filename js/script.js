...
//===========================================================================
// Week 3 
// Learnt about functions, hoisting, arrow functions, and arrays
//===========================================================================

// function multiple(y, z) {
//     return y * z;
// }
// let value = multiple(5, 10);

// console.log(`The product is ${value}`);
...
// Arrow function
const mod = (a, b) => a%b
console.log('The remainder is', mod(10, 3));

let newArr = ['Ram', 'Shyam', 'Hari', 'Sita', 'Gita'];
console.log(newArr);
console.table(newArr);

newArr.push('Maya'); // add at the end
console.table(newArr);
...
newArr.unshift('Hanuman'); // add at the beginning
console.table(newArr);
